    ...
    return (
        <nav className="bg-neutral-900 sticky top-0">
            ...
            {toggle && <div className="mobile-menu md:hidden">
                ...
                <a href="/journal" className="hover:bg-neutral-800 block px-4 py-4 text-white font-sans font-semibold">Sign In</a>
...
const AuthShowcase: React.FC = () => {
    ...
    return (
        <button
          className="py-2 px-3 bg-white text-neutral-900 rounded font-sans font-semibold hover:bg-neutral-200"
